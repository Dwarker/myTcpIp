...
static const uint8_t netdev0_hwaddr[] = { 0x0a, 0x00, 0x27, 0x00, 0x00, 0x10 };
#else
static const char netdev0_ip[] = "10.0.3.16"; //自己的IP
static const char netdev0_gw[] = "10.0.3.2";
static const char friend0_ip[] = "10.0.3.15";//网桥IP
